...
export const medicalData = {
  ...
  "XRay1": {
    ...
    probabilities: [ 
      { condition: "Atelectasis", probability: 3 },
      { condition: "Cardiomegaly", probability: 5 },
      { condition: "Consolidation", probability: 1 },
      { condition: "Nodule/Mass", probability: 2 },
      { condition: "Pneumonia", probability: 1 },
      { condition: "Pneumothorax", probability: 0 },
    ],
    zonalAnalysis: [
  ...
  "XRay2": {
    ...
    probabilities: [
      { condition: "Atelectasis", probability: 25 },
      { condition: "Cardiomegaly", probability: 60 },
      { condition: "Consolidation", probability: 92 },
      { condition: "Nodule/Mass", probability: 8 },
      { condition: "Pneumonia", probability: 89 },
      { condition: "Pneumothorax", probability: 1 },
    ],
    zonalAnalysis: [
  ...
  "ECG2": {
    ...
    rhythmDetails: {
      ...
      pWave: "Absent; Fibrillatory waves detected",
